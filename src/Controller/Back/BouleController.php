...
class BouleController extends AbstractController
{
    ...
    {
        return $this->render('back/boule/index.html.twig', [
    ...
    public function new(Request $request, BouleRepository $bouleRepository): Response
    {
        ...
        return $this->renderForm('back/boule/new.html.twig', [
            'boule' => $boule,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('back/boule/show.html.twig', [
            'boule' => $boule,
        ]);
    }
    ...
    public function edit(Request $request, Boule $boule, BouleRepository $bouleRepository): Response
    {
        ...
        return $this->renderForm('back/boule/edit.html.twig', [
            'boule' => $boule,
            'form' => $form,
        ]);
    }
